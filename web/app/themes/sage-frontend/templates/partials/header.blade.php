<div class="content">
	...
	<div class="page-header row-fluid">
		...
		<div class="col-12 col-md-5 float-md-right">
			<div class="row">
				<div class="social col-xs-8 offset-sm-0 col-sm-12">
					<a href="" class="float-sm-right btn btn-social-icon">
			...
			<div class="row">
				<div class="col-10 col-sm-11 col-md-9 ml-lg-auto">
					<input type="text" class="form-control front-search " placeholder="search">
				</div>
