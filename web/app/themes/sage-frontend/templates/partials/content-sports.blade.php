<!-- Sports section -->
<div class="row top10">
	@php($args = array('category_name'=>'Sports', 'posts_per_page'=>1, 'meta_query' => array(array('key' => '_thumbnail_id','compare' => 'EXISTS'))))
	...
	<div class="col-md-6 col-12">
		@php($inner_args = array('category_name'=>'Sports', 'posts_per_page'=>4, 'post__not_in'=>array($first_post)))
